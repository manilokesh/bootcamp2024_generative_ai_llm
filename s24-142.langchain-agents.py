...
question = "What is the capital city of TamilNadu and what is the weather forcast today ?"

response = agent_executor.invoke({"input": question}, config={"callbacks": [LoggingHandler(),StdOutCallbackHandler()]}) 
